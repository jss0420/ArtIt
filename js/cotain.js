...
//   ctx.strokeStyle = 'rgb(57, 19, 19)';
  ctx.globalAlpha = 0.6;
  ctx.lineWidth=1;


  var g = ctx.createLinearGradient(500,500,300,300); 
  g.addColorStop(0, '#110303'); 
  g.addColorStop(0.3, '#490B0B'); 
  g.addColorStop(1, '#110303'); 
  ctx.strokeStyle = g;    
  ctx.strokeRect(0,1,150,60); 
