...
var _castle = $('.castle');
TweenLite.set(_castle, {rotationZ: 0});
tl5.add([
    TweenLite.to(_castle, 1.0, {rotationZ: 0, delay: 0.0, force3D: true}),
    TweenLite.to(_castle, 1.0, {rotationZ: 0, delay: 1.0, force3D: true}),
...
var _wing = $('.wing');
TweenLite.set(_wing, {rotationY: 45});
tl7.add([
    TweenLite.to(_wing, 1.0, {rotationY: -45, x: -5, delay: 0.0, force3D: true}),
    TweenLite.to(_wing, 1.0, {rotationY: 45, x: 0, delay: 1.0, force3D: true}),
]);
